  ...
  return (
    <div className={styles.about}>
      ...
      <div style={{ marginBottom: '40px' }}>
        <h1>О проекте</h1>
        <p>
          <b>Pop Blast Sneaker</b> - Pop Blast Sneaker — проект, созданный для личного интереса. В нем реализованы удобная навигация, управление глобальным состоянием, адаптивная верстка и интеграция с внешними API. 

Все компоненты и ключевой функционал, включая корзину, избранное, поиск с debounce, фильтрацию данных, мобильное меню, Breadcrumb, DropDown-меню и уведомления, разработаны с нуля без использования сторонних UI-библиотек.
        </p>
        <p>
